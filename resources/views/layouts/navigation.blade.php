    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('jobs.index') }}" class="flex items-center gap-2">
                        <span class="text-2xl font-bold">
                            <span class="text-gray-900">Job</span><span class="text-violet-600">hunt</span>
                        </span>
                    </a>
                </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:gap-3">
                ...
                @else
                    <a href="{{ route('login') }}" class="inline-flex items-center px-4 py-2 text-sm font-semibold rounded-lg text-gray-700 border border-gray-200 hover:bg-gray-50 transition-colors">
                        {{ __('Log in') }}
                    </a>
