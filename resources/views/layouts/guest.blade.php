...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans text-gray-900 antialiased">
        <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-primary-light dark:bg-primary-dark">
            <div>
                <a href="/">
            ...
            <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white dark:bg-primary-darker shadow-md overflow-hidden sm:rounded-lg">
                {{ $slot }}
            </div>
        </div>
    </body>
